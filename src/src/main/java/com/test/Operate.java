   ...
   //search animal record
    ...
    //sort by animal age
        public  void sortbyAnimalAge(){
            Collections.sort(this.animalsList, new Comparator<Animal>() {
                @Override
    ...
    public void modifyAdopter() {
        ...
        for (Adopter adopter : adoptersList) {
            if (adopterName.equals(adopter.getName())) {
               ...
               adopter.setAge(newAge);
               System.out.print("Age is modified successfully!");
    ...
    public void modifyAnimal() {
            ...
            for (Animal animal : animalsList) {
                if (animalName.equals(animal.getName())) {
                    ...
                    System.out.print("Enter the new Variety:");
                    String newVariety = sc.next();
                    animal.setVariety(newVariety);
                    System.out.println("Variety is modified successfully!");

                    System.out.print("Enter the new Gender:");
                    String newGender=sc.nextLine();
                    animal.setGender(newGender);
                    System.out.println("Gender is modified successfully!");


                    System.out.print("Enter the new HealthCondition:");
                    String newHealthCondition=sc.nextLine();
                    animal.setHealthCondition(newHealthCondition);
                    System.out.println("HealthCondition is modified successfully!");
                    break;
        }
    }}
